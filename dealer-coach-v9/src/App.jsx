          ...
          {isMgr&&(
            <div style={{marginTop:10,paddingTop:10,borderTop:`1px solid ${C.border}`}}>
              ...
              {weakObjs.length>0 ? weakObjs.map((w,i)=>{
                ...
                return <div key={i} style={{display:'flex',alignItems:'center',gap:8,marginBottom:i<weakObjs.length-1?8:0,background:'rgba(26,107,255,0.06)',border:'1px solid rgba(26,107,255,0.15)',borderRadius:8,padding:'8px 10px'}}>
                  <div style={{flex:1}}>
                    <div style={{fontSize:11,color:C.white,fontWeight:600,marginBottom:1}}>{w.label}</div>
                    <div style={{fontFamily:fH,fontSize:10,fontWeight:700,color:w.pct<40?C.red:C.yellow}}>{w.pct}% win rate — needs work</div>
                  </div>
