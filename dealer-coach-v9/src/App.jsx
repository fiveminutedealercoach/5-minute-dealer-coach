...
function VoiceDrill({onLog,dealer,preloadScript,onClearPreload}) {
  ...
  const PERSONAS = [
    ...
    {id:'dave', name:'Dave', emoji:'📱', dept:'sales', gender:'male',
     cats:['Handling Objections & Value Selling','Sales Tactics for Higher Gross','Mindset & Gross Awareness'],
    ...
    {id:'linda', name:'Linda', emoji:'🛡', dept:'sales', gender:'female',
     ...
     opener:(obj)=>`I want to be upfront — the last time I bought a car I felt really pressured and I ended up regretting it. I need to take my time on this. ${obj}`},
    {id:'mike', name:'Mike', emoji:'💰', dept:'sales', gender:'male',
     ...
     opener:(obj)=>`Look, I don't care about sticker price. All I want to know is my monthly payment. Keep it under four-fifty and we have a deal. ${obj}`},
    {id:'gary', name:'Gary', emoji:'🚛', dept:'sales', gender:'male',
     ...
     opener:(obj)=>`I've had this truck six years and taken great care of it. My neighbor sold his for twelve thousand last month. I'm not taking less than ten for mine. ${obj}`},
    {id:'carol', name:'Carol', emoji:'👥', dept:'sales', gender:'female',
     cats:['Add-Ons & After-Sale','Menu Selling & Finance','Used Car Gross & Reconditioning'],
     ...
     opener:(obj)=>`I love the car but I think a lot of these extras are things I could add later or honestly get cheaper somewhere else. ${obj}`},
    ...
    {id:'frank', name:'Frank', emoji:'⏳', dept:'service', gender:'male',
     ...
     opener:(obj)=>`That car has a hundred and forty thousand miles and I've never had a problem. Every time I come in here you find something new that supposedly needs fixing. ${obj}`},
    {id:'barbara', name:'Barbara', emoji:'💸', dept:'service', gender:'female',
     ...
     opener:(obj)=>`Seven hundred and forty dollars?! I called my cousin's shop this morning and he said three-fifty for the same job. How do you justify that? ${obj}`},
    {id:'ray', name:'Ray', emoji:'🏪', dept:'service', gender:'male',
     ...
     opener:(obj)=>`My guy Tony at the shop on Fifth has been doing my cars for fifteen years. He's never done me wrong and his prices are always better. ${obj}`},
    {id:'susan', name:'Susan', emoji:'📞', dept:'service', gender:'female',
     cats:['Phone Ups & Appointment Setting','MPI Conversion','Selling the Menu & Recommended Services'],
     ...
     opener:(obj)=>`Before I approve any of this I need to call my husband. He handles everything mechanical and I don't want to agree to something he would question. ${obj}`},
    {id:'tom', name:'Tom', emoji:'⌛', dept:'service', gender:'male',
     cats:['Mindset & Customer-Pay Focus','Selling the Menu & Recommended Services','MPI Conversion','Selling Specific Services'],
     ...
     opener:(obj)=>`The car is driving fine right now. Money is tight this month. I will bring it back in a few weeks when things settle down. ${obj}`},
  ]
