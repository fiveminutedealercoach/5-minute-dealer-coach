...
One coaching whisper:`}],
  ...
  const submit = async () => {
    ...
    if(livePhase === 'live' && activeS) {
      ...
      const systemPrompt =
        'You are ' + persona.name + ', a real customer at a car dealership. Stay in character throughout.
...
' +
        '- 2-3 sentences max. Spoken language only — no formal writing.
' +
...
' +
      ...
      // Build alternating messages from transcript history
      const convoMessages = []
      let isFirst = true
